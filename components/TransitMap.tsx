...
const losAngelesToShanghaiOceanRoute: RouteWaypoint[] = [
  ...
  { name: "Tsugaru Strait East Approach", coordinate: [41.8, -218.9] },
  { name: "Tsugaru Strait Transit", coordinate: [41.45, -219.7] },
  { name: "Tsugaru Strait West Exit", coordinate: [40.9, -220.9] },
  { name: "Sea of Japan Southbound Turn", coordinate: [39.3, -222.2] },
  { name: "Western Honshu Offshore", coordinate: [36.7, -224.2] },
  { name: "Kyushu Offshore Approach", coordinate: [33.5, -228] },
  { name: "South of Kyushu", coordinate: [31.8, -230.5] },
  { name: "East China Sea Approach", coordinate: [30.9, -233.5] },
