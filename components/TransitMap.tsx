...
const losAngelesToShanghaiOceanRoute: RouteWaypoint[] = [
  ...
  { name: "Tsugaru Strait Approach", coordinate: [41.7, -219] },
  { name: "Tsugaru Strait", coordinate: [41.45, -219.7] },
  { name: "Pacific Side of Honshu", coordinate: [38.2, -218.9] },
  { name: "South of Honshu", coordinate: [34.5, -221] },
  { name: "Kii Channel Offshore", coordinate: [33.3, -224] },
