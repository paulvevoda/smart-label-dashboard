...
const losAngelesToShanghaiOceanRoute: RouteWaypoint[] = [
  ...
  { name: "Kuril Approach", coordinate: [47.5, -205] },
  { name: "Hokkaido Offshore Approach", coordinate: [43.6, -216.9] },
  { name: "Tsugaru Strait East Approach", coordinate: [41.85, -218.7] },
...
const getVehicleIcon = (asset: LogisticsAsset, isSelected: boolean, mode: VehicleMode) => {
  ...
  const glyph = mode === "rail"
    ...
    : mode === "ocean"
      ...
      : mode === "air"
        ? `<svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false" style="display:block;fill:#020617;">
          <path d="M11.2 2.6h1.6c.6 0 1.1.5 1.2 1.1l.4 2.5h2.5c.7 0 1.2.5 1.2 1.2v.8h2.9c.6 0 1 .4 1 1v1.4c0 .6-.4 1-1 1h-3.4l-1.8 2.1h-1.8v1.4h2.5c.5 0 1 .4 1 1v1.2c0 .6-.4 1-1 1h-3l-.6 2.6c-.1.5-.6.9-1.1.9h-1.6c-.5 0-1-.4-1.1-.9l-.6-2.6h-3c-.6 0-1-.4-1-1v-1.2c0-.6.4-1 1-1h2.5v-1.4H8.2l-1.8-2.1H3c-.6 0-1-.4-1-1V9.2c0-.6.4-1 1-1h2.9v-.8c0-.7.5-1.2 1.2-1.2h2.5l.4-2.5c.1-.6.6-1.1 1.2-1.1zm.5 2.2-.3 1.4h1.2l-.3-1.4h-.6zm-3.5 3.8v.9l1.2 1.5h5.2l1.2-1.5v-.9h-7.6zm3.8 3.9h-.9v2h1.8v-2H12zm-2.2 4.6v.4h4.4v-.4H9.8zm1.9 2.6.2.9h.2l.2-.9h-.6z"/>
          <path d="M8.3 13.2h7.4v.8H8.3zm-2.1-2.8h11.6v.8H6.2z"/>
      </svg>`
      : `<svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false" style="display:block;fill:#020617;">
